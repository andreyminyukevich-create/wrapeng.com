...
// ── Хелперы ──────────────────────────────────────────────────────
if (typeof q   === 'undefined') var q   = s => document.querySelector(s);
if (typeof qa  === 'undefined') var qa  = s => document.querySelectorAll(s);
if (typeof fmt === 'undefined') var fmt = n => parseFloat((n || 0).toFixed(2)).toLocaleString('ru-RU', {
  minimumFractionDigits: 2,
  maximumFractionDigits: 2
});
if (typeof r100      === 'undefined') var r100      = n => Math.round((n || 0) * 100) / 100;
if (typeof capitalize === 'undefined') var capitalize = s => s.charAt(0).toUpperCase() + s.slice(1);

// ── Глобальное состояние ─────────────────────────────────────────
if (typeof disc        === 'undefined') var disc        = 0;
if (typeof chart       === 'undefined') var chart       = null;
if (typeof costCounter === 'undefined') var costCounter = 0;
if (typeof dynCounter  === 'undefined') var dynCounter  = 0;
