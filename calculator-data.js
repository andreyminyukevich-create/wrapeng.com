/**
 * calculator-data.js — v1.1 (актуальная версия из calculator.html)
...
const serviceDescriptions = {
  'Полная защита кузова': 'Полная защита глянцевых кузовных элементов автомобиля с разбором съемных элементов и подготовкой кузова',
  ...
  'PPF прозрачный (кузов)': 'Полная защита глянцевых кузовных элементов автомобиля',
  'PPF цветной (кузов)': 'Полная защита кузовных элементов цветной пленкой',
  'PPF матовый (кузов)': 'Полная защита кузовных элементов матовой пленкой',
