/**
 * calculator-engine.js — v1.1 (актуальная версия из calculator.html)
 * Бизнес-логика: сбор данных формы, расчёт итогов, налоги, наценки.
 * Зависит от: calculator-data.js (q, qa, r100, serviceDescriptions)
 */
...
function collectAll() {
  ...
  if (impactWrapMat || impactWrapMot || impactPrepMat || impactPrepMot || impactArmMat || impactArmMot || impactCosts) {
